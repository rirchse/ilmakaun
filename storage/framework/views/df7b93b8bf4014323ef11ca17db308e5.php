        ...
        <div id="rev_main" class="rev_slider fullwidthabanner white" data-version="5.4.1">
            <ul>
                ...
                <li data-index="rs-01" data-transition="fade" data-slotamount="default" data-easein="Power100.easeIn" data-easeout="Power100.easeOut" data-masterspeed="2000" data-fsmasterspeed="1500" data-param1="01">
                    <!-- MAIN IMAGE -->
                    <img src="<?php echo e($setting->banner_image); ?>"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        <div class="contactus-wrapp" style="margin-top:-130px; margin-bottom: 30px; background: rgba(0,0,0,0.5)">
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <form action="<?php echo e(route('home.contactForm')); ?>" method="POST" class="getin_form wow fadeInUp" data-wow-delay="400ms">
                        <?php echo csrf_field(); ?>
                        <div class="row">
        ...
        <div class="row d-flex align-items-center">
            <div class="col-lg-6 col-md-7 col-sm-7 text-sm-start text-center wow fadeInLeft" data-wow-delay="300ms">
                <div class="heading-title mb-4">
                    <h2 class="darkcolor font-normal bottom30" style="font-size:36px"> About <span class="defaultcolor"> <?php echo e($setting->about_title); ?></span></h2>
                </div>
                <p class="bottom35"><?php echo $setting->about_text; ?></p>
            </div>
            <div class="col-lg-5 offset-lg-1 col-md-5 col-sm-5 wow fadeInRight" data-wow-delay="300ms">
                <div class="image"><img alt="SEO" src="<?php echo e($setting->about_image? $setting->about_image:'images/about.png'); ?>"></div>
            </div>
        </div>
    </div>
</section>
<!--Some Feature ends-->
<?php endif; ?>
<?php if($setting->work_process): ?>
<!-- WOrk Process-->
<section id="our-process" class="padding" style="background:url(<?php echo e($setting->bg1?$setting->bg1:'/images/testimonial-bg.jpg'); ?>);">
    <div class="container">
        <div class="row">
...
<!--Work Process ends-->
<?php endif; ?>
<?php if($setting->service): ?>
<!-- Our Services -->  
<section id="services" class="bglight padding" style="background:url(<?php echo e($setting->bg2?$setting->bg2:''); ?>);">
    <div class="container">
                    ...
                    <div class="item">
                        <div class="team-box">
                            ...
                            <div class="team-content">
                                <h4 class="darkcolor"><?php echo e($product->title); ?></h4>
                                <p>Resident Price: <span style="width:50%">KSH<?php echo e($product->resident); ?></span>
                                </p>
                                <p>Non Resident Price: <span style="width:50%">$<?php echo e($product->non_resident); ?></span></p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="heading-title bottom30 wow fadeInUp" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInUp;text-align:center;">
                    <a href="<?php echo e(route('home.portfolio')); ?>" class="button btnsecondary gradient-btn  mb-sm-0 mb-4">View More</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="cbp-l-loadMore-button ">
                        <a href="<?php echo e(route('home.gallery')); ?>" class="cbp-l-loadMore-link button py-1 button gradient-btn whitecolor transition-3" rel="nofollow">VIEW MORE</a>
                    </div>
                    <br>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div id="ourteam-slider" class="owl-carousel">
                    ...
                    <div class="item shadow" style="padding:15px">
                        <div class="team-box">
                            <div class="image">
                                <a href="<?php echo e(route('home.blog.show', $blog->id)); ?>">
                                    <img src="<?php echo e($blog->blog_image ? $blog->blog_image : '/images/blog-image.jpg'); ?>" alt="">
                                </a>
                            </div>
                            <div class="team-content">
                                <h4 class="darkcolor">
                                    <a href="<?php echo e(route('home.blog.show', $blog->id)); ?>"><?php echo e($blog->blog_title); ?></a></h4>
                                <p><a href="<?php echo e(route('home.blog.show', $blog->id)); ?>">Read more...</a></p>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/www/ilmakaun/resources/views/home/index.blade.php ENDPATH**/ ?>