           ...
           <div class="col-lg-8 col-md-7">
               <div class="news_item shadow mb-0">
                   ...
                   <div class="news_desc text-center text-md-start">
                       <h3 class="text-capitalize font-normal darkcolor"><a href="javascript:void(0)">{{ $portfolio->title }}</a></h3>
                       ...
                       <p class="bottom35">{!! $portfolio->details !!}</p>
               ...
               <aside class="sidebar whitebox mt-5 mt-md-0">
                   ...
                   <div class="widget heading_space_half wow fadeIn" data-wow-delay="350ms">
                       ...
                       <div class="single_post d-table bottom15">
                           <a href="{{ route('home.portfolio.show', $portfolio->id) }}" class="post"><img src="{{ $portfolio->image }}" alt=""></a>
                           <div class="text">
                               <a href="{{ route('home.portfolio.show', $portfolio->id) }}">{{ $portfolio->title }}</a>
                               <span>{{ date('M d, Y', strtotime($portfolio->date)) }}</span>
                           </div>
                       </div>
                       @endforeach
                   </div>
