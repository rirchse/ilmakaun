    ...
    <nav class="navbar navbar-expand-lg transparent-bg static-nav">
        <div class="container">
            <a class="navbar-brand center-brand" href="/">
                <img src="{{$setting->logo_transparent}}" alt="logo" class="logo-default" style="max-width:{{$setting->logo_width}}px">
                <img src="{{$setting->logo}}" alt="logo" class="logo-scrolled" style="max-width:{{$setting->logo_width}}px">
            </a>
...
@if($_SERVER['REQUEST_URI'] != '/')
    <section id="main-banner-page" style="width:100%; height:80px; background: url({{$setting->banner_image}});">
    </section>
